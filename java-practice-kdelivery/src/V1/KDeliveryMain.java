...
public class KDeliveryMain {
    ...
    static Scanner s = new Scanner(System.in); // 사용자의 입력을 받는 객체 생성
    ...
    public void selectAddShopMenu() {
        ...
        //중복해서 등록할 수 없게
        if (shopIdx < SHOP_MAX) {
            System.out.println("[안내] 음식점 정보를 등록합니다.");
            System.out.print("음식점 상호명을 입력하세요.");
            System.out.print(">>>");
            String shopName = s.nextLine();
            shops[shopIdx++] = new Shop(shopName);
            System.out.println("[안내] 음식점 정보가 등록되었습니다.");
        } else {
    ...
    void selectDashboardMenu() {
        ...
        //전체 별점
        // 있으면 출력하고 없으면 넘김
        System.out.println("[안내] 등록된 가게 정보를 출력합니다.");
    ...
    public static void main(String[] args) {
        if (true) {
            System.out.println("[치킨의 민족 프로그램 V1]\n" +
                    "-------------------------");
            System.out.println("[안내] 기능을 선택해 주세요.");
